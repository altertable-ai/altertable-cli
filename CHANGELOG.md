...
- Simplify `altertable update` to install by default, add the `upgrade` alias and `--check` mode, describe explicit older targets accurately, and resolve compiled self-update paths reliably.
